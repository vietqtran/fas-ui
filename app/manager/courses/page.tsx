...
const page = () => {
  ...
  const columns: GridColDef[] = [
    ...
    { field: "noCredit", headerName: "NoCredit", width: 80 },
    { field: "createdAt", headerName: "Create At", width: 150 },
    { field: "updatedAt", headerName: "Update At", width: 150 },
    {
      field: "status",
      headerName: "Status",
      width: 80,
  ...
  return (
    <ManagerLayout>
      <div className="container">
        <h1 className="my-8 text-3xl font-bold">List of Coures</h1>
