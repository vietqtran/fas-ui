        ...
        const updateDateRange = () => {
            ...
            setDays(
                newDays.map((date) => {
                    ...
                    return {
                        weekDay: dateString.split(',')[0],
                        date: dateString.split(',')[1].trim()
                    };
                })
            );
        }
                    ...
                    <div className='flex flex-col items-center gap-4 md:flex-row'>
                        <div>
                            ...
                            <Select
                                id='year-select'
                                labelId='year'
                                className={`w-48 ${Number(year) === Number(years[0])
                                    ? 'cursor-not-allowed'
                                    : 'cursor-pointer'
                                    }`}
                                value={year}
                    ...
                    <div className='md:hidden'>
                        <div className='flex items-center justify-between gap-1'>
                            {days.map((day, i) => (
                                <div
                                    key={i}
                                    className='bg-green-500 mx-auto w-full max-w-[150px] cursor-pointer rounded-lg text-center text-white'
                                >
                                    <div className='text-sm font-semibold'>
                                        {day.weekDay}
                                    </div>
