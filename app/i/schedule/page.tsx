...
import { getInstructorActivityByWeekYear } from "@/helpers/api/activity";
import ActivityInstructor from "@/components/Instructor/ActivityInstructor";
...
const InstructorSchedule = () => {
  ...
  useEffect(() => {
    const fetchActivity = async () => {
      if (user) {
        const data = await getInstructorActivityByWeekYear(
          user?.instructor?.id || "",
          week,
          year
        );
