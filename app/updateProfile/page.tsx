            ...
            <div className='container mx-auto py-5 text-gray-600'>
               ...
               <div className='mt-5 bg-gray-200 p-3'>
                  ...
                  <p className='text-center'>
                     Đây là những thông tin quan trọng, được nhà trường dùng để
                     in bằng tốt nghiệp, bảng điểm tốt nghiệp và các chứng chỉ
                     cấp cho sinh viên, ngoài ra còn để báo cáo các Bộ ngành
                     liên quan nên sinh viên cần nhập thông tin đầy đủ, chính
                     xác.
                  </p>
               </div>
               <div>
